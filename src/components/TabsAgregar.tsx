    ...
    return (
        <Tabs defaultValue="Ingreso" className="flex flex-col items-center w-[95%] mt-5">
            <TabsList className="grid w-full grid-cols-2 bg-[#090d2b] gap-4">
                <TabsTrigger value="Ingreso" className="text-white data-[state=active]:bg-[#132233]">Ingreso</TabsTrigger>
                <TabsTrigger value="Gasto" className="text-white data-[state=active]:bg-[#132233]">Gasto</TabsTrigger>
            </TabsList>
