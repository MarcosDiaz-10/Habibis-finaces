              ...
              <FormItem>
                ...
                <FormControl>
                  <Select onValueChange={field.onChange} value={field.value}>
                    <SelectTrigger className="border-none w-[150px] bg-[#090d2b] text-white">
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input
                  type="text"
                  className="bg-[#090d2b] border-none text-white"
                  ...
                  <PopoverTrigger asChild>
                    <FormControl>
                      <Button
                        variant={"outline"}
                        className={cn(
                          "w-[240px] pl-3 text-left font-normal bg-[#090d2b] border-none text-white ",
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex flex-col">
              ...
              <FormControl>
                <ToggleGroup type="multiple" className="flex bg-[#132233] w-full gap-2" onValueChange={field.onChange} value={field.value}>
